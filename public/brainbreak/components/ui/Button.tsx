...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-teal-500 text-white hover:bg-teal-600 shadow-lg shadow-teal-200 focus:ring-teal-500 border border-transparent",
    outline: "bg-white text-slate-700 border-2 border-slate-200 hover:border-indigo-300 hover:text-indigo-600 focus:ring-slate-200",
